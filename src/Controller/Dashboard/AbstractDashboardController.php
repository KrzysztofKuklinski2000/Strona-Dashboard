...
abstract class AbstractDashboardController extends AbstractController {
  ...
  protected function getSingleData(): array{
    ...
    if ($postId === null || !ctype_digit((string) $postId)) $this->redirect("/?dashboard=". $this->getModuleName());
    $postId = (int) $postId;
    return $this->dataService->getPost($postId, $this->getModuleName() === 'start' ? 'main_page_posts' : $this->getModuleName());
  }
