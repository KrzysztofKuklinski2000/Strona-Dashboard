...
INSERT INTO `camp` (`city`, `city_start`, `date_start`, `date_end`, `time_start`, `time_end`, `place`, `accommodation`,
                    `meals`, `trips`, `staff`, `transport`, `training`, `insurance`, `cost`, `advancePayment`,
                    `advanceDate`, `guesthouse`)
VALUES ('CHEMIK  w Szczawnicy', 'Gdynia Główna.Os                                ', '2024-06-28', '2024-07-07',
        '13:00:00', '18:00:00', 'Domem Wypoczynkowym  CHEMIK , ul. Park Dolny 11, 34-460 Szczawnica.\r\n\r\n',
        'ZAKWATEROWANIE: w pokojach 2- 6 lub osobowych z węzłem sanitarnym.',
        'WYŻYWIENIE: trzy posiłki dziennie (wyżywienie pełno-kaloryczne. dostosowane do treningu wyczynowego, bez ograniczeń).',
        'AUTOKAROWĄ wycieczkę do zamków Niedzica i Czorsztyn ( lub inny ), Jaskini Bielskiej na Słowacji ( Prosimy o zabranie Dowodów Osobistych  lub paszportów).\r\n\r\nWYCIECZKI: piesze trasami turystycznymi ( 2-3 trasy), spływ pontonami po Dunajcu lub inne.\r\n\r\nZWIEDZANIE Szczawna i okolicy... i inne nespodzianki',
        'KADRĘ opiekunów ( jeden opiekun na 10 -15 dzieci i młodzieży) , kadrę trenerską.',
        'TRANSPORT PKP (proszę o zabranie aktualnej legitymacji szkolnej !!! ) , autokar.',
        'TRENINGI karate kyokushin jeden, dwa ( uzależnione od programu dnia ) razy dziennie dla członków Klubu i osób zainteresowanych , gry zespołowe dla pozostałych uczestników wypoczynku.',
        'UBEZPIECZENIE i opiekę medyczną ( pielęgniarka 24 godz , lekarz 8 godz dziennie na terenie ośrodka)).																																',
        2350, 500, '2024-02-15', 'Domu  Wypoczynkowego CHEMIK  w Szczawnicy');
...
VALUES ('kyokushin.wejherowo@gmail.com', 123456789, 'Ul. Nanicka 22, Wejherowo');
...
INSERT INTO `fees` (`reduced_contribution_1_month`, `reduced_contribution_2_month`, `family_contribution_month`,
                    `reduced_contribution_1_year`, `reduced_contribution_2_year`, `family_contribution_year`,
                    `extra_information`, `fees_information`)
VALUES (150, 220, 280, 1500, 2200, 2800,
        'Składka członkowska i miesięczna ( łącznie składka ) obowiązuje wszystkich Członków Klubu przez 12 miesięcy w roku. Zajęcia prowadzimy przez cały rok, w wakacje i ferie też. W okresie wakacji składka jest obniżona. W przypadku, gdy członek Klubu nie uczestniczył w zajęciach np: z powodu choroby, oraz w innych szczególnych wypadkach nieobecności dłuższej niż 3 tygodnie w miesiącu, może być zmniejszona na pisemny wniosek Członka ( lub rodziców/opiekunów prawnych) do wysokości 100 zł za miesiąc. Wpisowe obecnie jest zawieszone. Obowiązuje tylko przy ponownym wstąpieniu do Klubu.',
...
INSERT INTO `gallery` (`id`, `image_name`, `description`, `created_at`, `updated_at`, `position`, `category`, `status`)
VALUES (2, '1.jpg', 'Obóz karate!!!!', '2025-09-06', '2025-10-08', 3, 'training', 1),
...
INSERT INTO `important_posts` (`id`, `title`, `description`, `created`, `updated`, `status`, `important`, `position`)
VALUES (1, 'Remont Sal 01.07 - 31.07 ',
        '                   W związku z remontem salki na basenie w Wejherowie i salki w SP 4 w Redzie, zajęcia odbywają się tylko w\r\nRedzie w Szkole Podstawowej nr 6 na ul. Gniewowskiej 33. Remont będzie trwał od 01.07 - 31.        ',
        '2025-08-02', '2025-10-16', 0, 0, 1),
       (2, 'ZAPISY 2025/26  ',
        '     ZAPISY Rozpoczynamy zapisy dzieci od lat 5 , młodzież i dorośli na rok 2025/2026 do sekcji karate Kyokushin w Wejherowie i Redzie    ',
        '2025-08-02', '2025-09-04', 1, 0, 2);
...
(
    ...
    `status`      tinyint                               NOT NULL,
    `position`    int                                   NOT NULL DEFAULT '1',
    `type`        varchar(50)                           NOT NULL DEFAULT 'simple_text',
    `payload`     JSON
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_polish_ci;
...
INSERT INTO `news` (`id`, `title`, `description`, `created`, `updated`, `status`, `position`)
VALUES (35, 'MISTRZOSTWA POLSKI 2011',
        '14 maja 2011 w Mielnie odbyły się XXXVIII Mistrzostwa Polski Seniorów Karate Kyokushin. W zawodach wzięło udział 99 karateka z 41 ośrodków. Organizatorem był Mieleński Klub Sztuk i Sportów Walki. Sędzią głównym był shihan Andrzej Drewniak. Patryk Borowski zajął 2 miejsce w kategorii kumite -80 kg',
        '2025-07-28', '2025-07-28', 1, 32),
       (36, 'KRAKÓW 2011 OBÓZ LETNI',
        'W dniach 21-24 lipca na obiektach Akademii Wychowania Fizycznego w Krakowie odbył się 38 Wschodnioeuropejski Letni Obóz Kyokushin .  Uczestniczyło w nim 190 karateka z Austrii, Czech, Mołdawi, Niemiec, Polski, Rosji i Ukrainy. Zajęcia prowadził  shihan Antonio Pinero 7 dan i  mistrz Świata w kata,  mistrz Europy w kumite shihan Jose Lezkano 5 dan. Celem obozu było doszkalenie kierowników ośrodków i instruktorów. Treningi odbywały się 4 razy dziennie zgodnie z programem przygotowanym przez shihan',
        '2025-07-28', '2025-07-28', 1, 31),
       (37, 'MISTRZOSTWA EUROPY WARNA 2011',
        'W dniach 15-16 października 2011 w Warnie odbyły się Otwarte Mistrzostwa Europy Kyokushin Karate Warna 2011. Wzięło w nich udział 280 uczestników z 16 krajów : Armenia, Bulgaria, Czechy, Francja, Grecja, Hiszpania, Holandia, Kazachstan, Niemcy, Norwegia, Polska, Portugalia, Rosja, Rumunia, Turcja i Ukraina.',
        '2025-07-28', '2025-07-28', 1, 30),
       (38, 'PUCHAR POLSKI SUWAŁKI 2011',
        'W dniu 29 10.2011 w Suwałkach odbył się Puchar Polski w kumite w Karate Kyokushin.Uczestniczyło w nim 93 zawodników z 36 ośrodków. Organizatorem zawodów był Suwalski Klub Karate Kyokushin.  Nasz Klub reprezentowało trzech zawodników:  Patryk Borowski 2 kyu, Piotr Puchalski 2 kyu oraz Piotr Tomaszewski 2 kyu.\r\n\r\nPatryk Borowski zajął I miejsce w kumite Kat – 80 kg,\r\n\r\nPiotr Tomaszewski V miejsce w kat – 80 kg\r\n\r\nDrużynowo VI- IX ( 5 pkt. ) miejsce\r\n\r\n',
        '2025-07-28', '2025-07-28', 1, 29),
       (39, 'ORKIESTRA ŚWIĄTECZNEJ POMOCY 2012',
        'W dniu 08.01.2012 dzieci naszego klubu wsparły pokazem Orkiestrę Świątecznej Pomocy .', '2025-07-28',
        '2025-07-28', 1, 28),
       (40, 'SAMORZĄD WOJEWÓDZTWA POMORSKIEGO',
        'Samorząd Województwa Pomorskiego wsparł kwotą 3000,00 ( trzy tysiące ) organizację MISTRZOSTW MAKROREGIONU ZACHODNIEGO- WEJHEROWO 2012, które odbędą się w sali judo AKADEMII WYCHOWANIA FIZYCZNEGO I SPORTU w GDAŃSKU dnia 24 marca 2012 roku. DZIĘKUJEMY - ZARZĄD KLUBU KARATE KYOKUSHIN I SPORTÓW WALKI w Wejherowie - organizator',
        '2025-07-28', '2025-07-28', 1, 27),
       (41, 'MISTRZOSTWA MAKROREGIONU ZACHODNIEGO 2012',
        'Klub nasz 24.03.2012 roku był organizatorem Mistrzostw Makroregionu Zachodniego. Zawody odbyły się w hali judo Akademii Wychowania Fizycznego i Sportu w Gdańsku. Współorganizatorem był Samorząd Województwa Pomorskiego.',
        '2025-07-28', '2025-07-28', 1, 26),
       (42, 'WSPARCIE SAMORZĄDU GMINY WEJHEROWO',
        'Samorząd Gminy Wejherowo wsparł nasz Klub w realizacji zadania \" Organizacja szkolenia sportowego karate Kyokushin \" kwotą 2000 ( dwa tysiące ) złotych. Dotacja, zgodnie z projektem,  będzie przeznaczona na opłaty za wynajem sali sportowej.',
        '2025-07-28', '2025-07-28', 1, 25),
       (43, 'WSPARCIE SAMORZĄDU POWIATU WEJHEROWSKIEGO',
        'Samorząd Powiatu Wejherowskiego wsparł realizację zadania \" Organizacja Szkolenia Sportowego Karate Kyokushin \" kwotą 1000 ( jeden tysiąc ) zł. i  zadania \" Obóz sportowo-wypoczynkowy Lato 2012 \"  kwotą 1000 ( tysiąca ) zł.',
        '2025-07-28', '2025-07-28', 1, 24),
       (44, 'KURATORIUM - DOFINANSOWANIE',
        'Kuratorium Oświaty w Gdańsku dofinansowało obóz sportowo-wypoczynkowy Lato 2012 kwotą 3300 zł.', '2025-07-28',
        '2025-07-28', 1, 23),
       (45, 'ZGRUPOWANIE KADRY NARODOWEJ',
        'W CENTRUM JAPOŃSKICH SPORTÓW I SZTUK WALKI DOJO w Starej Wsi w dniach 02-08 odbyło się zgrupowanie kadry narodowej. W zgrupowaniu uczestniczyli : Jarosław Preis, Patryk Borowski, Piotr Puchalski, Piotr Tomaszewski i Konrad Kryspin.',
        '2025-07-28', '2025-07-28', 1, 22),
       (47, 'POPRZEZ SPORT KU LEPSZEJ PRZYSZŁOŚCI',
        ...
        '2025-07-28', '2025-07-28', 1, 21),
       (48, 'POWIAT PUCKI 2015',
        'Zadanie publiczne \" Organizacja szkolenia sportowego karate kyokushin \" zostało wsparte kwotą 500 zł  przez Powiat Pucki\r\n\r\n ',
        '2025-07-28', '2025-07-28', 1, 20),
       (49, 'GMINA MIASTA WEJHEROWO 2015',
        'Gmina Miasta Wejherowo dofinansowała kwotą 2000 zł realizację projektu \" Organizacja szkolenia sportowego karate Kyokushin \" realizowanego przez nasz Klub w ramach wspierania i upowszechniania kultury fizycznej.',
        '2025-07-28', '2025-07-28', 1, 19),
       (50, 'ZARZĄD POWIATU WEJHEROWSKIEGO 2015',
        'Zarząd Powiatu Wejherowskiego wsparł kwotą 1000 zł realizację zadania  \" Organizacja szkolenia sportowego karate Kyokushin \" oraz kwotą 1500 zł realizację projektu \" Obóz sportowo - wypoczynkowy Lato 2015 \"',
        '2025-07-28', '2025-07-28', 1, 18),
       (51, 'ZARZĄD POWIATU PUCKIEGO 2016',
        'Starostwo Puckie dofinansowało zadanie \" Szkolenie sportowe karate kyokushin\" kwotą 1000 zł organizację  zajęć karate kyokushin w Powiecie Puckim w roku 2016.',
        '2025-07-28', '2025-07-28', 1, 17),
       (52, 'ZARZĄD POWIATU WEJHEROWSKIEGO 2016',
        'Zarząd Powiatu Wejherowskiego dofinansował kwotą 2000 zł zadanie publiczne,  \" Obóz sportowo-wypoczynkowy Lato 2016 \" skierowane do dzieci i młodzieży niezrzeszonej i  członków naszego Klubu',
        '2025-07-28', '2025-07-28', 1, 16),
       (53, 'GMINA MIASTA WEJHEROWO 2016',
        'Zarząd Gminy Miasta Wejherowa dofinansował kwotą 2000 zł zadanie publiczne \" Organizacja Szkolenia Sportowego Karate Kyokushin \" realizowanego przez nasz Klub.',
        '2025-07-28', '2025-07-28', 1, 15),
       (54, 'SEMINARIUM STYCZEŃ 2017',
        'W dniach 21-22 stycznia w Gdyni odbyło się seminarium karate kyokushin poświęcone doskonaleniu technik i taktyki walki. Zajęcia prowadził Shihan Andrzej Drewniak 8 dan, asystowali Shihan Zdzisław Niedźwiedź 5 dan, sensei: Andrzej Kłujszo 4 dan, Eljasz Madej 4 dan, Paweł Olszewski 4 dan, Stanisław Samsel 4 dan.W seminarium uczestniczyło 90 karateka z ośrodków: Białogard, Brusy, Bydgoszcz, Chojnice, Gdańsk, Gdynia, Kołobrzeg, Koszalin, Lipno, Miastko, Nowogard, Postumino, Reda, Słupsk, Szczecinek, Wejherowo i Zielona  Góra. Z naszego Klubu uczestniczyły 4 osoby.',
        '2025-07-28', '2025-07-28', 1, 14),
       (55, 'PATRYK BOROWSKI',
        'W dniu 12.02.2017 minęła pierwsza  rocznica tragicznej śmierci Patryka medalisty Mistrzostw Polski, Pucharu Polski i Mistrzostw Europy\r\nPAMIĘTAMY',
        '2025-07-28', '2025-07-28', 1, 13),
       (56, 'MAGDA II MIEJSCE !',
        'W dniu 04.03.2017 roku w Gdańsku, odbyły się Mistrzostwa Makroregionu Zachodniego seniorów i juniorów  i Międzywojewódzkie Mistrzostwa Młodzików.\r\n\r\nOrganizatorem był klub Pomorska Akademia Sportu - Karate Kyokushin. Po raz pierwszy, oprócz kumite w formule kyokushin , rozegrano kumite w olimpijskiej formule WKF. Uczestniczyło w nich 170 zawodników z 22 ośrodków z 7 województw centralnej i zachodniej Polski. W zawodach uczestniczyło dwóch naszych reprezentantów: Magdalena Kuklińska i Szymon Skiba.  Magda zajęła 2 miejsce w kategorii kumite kobiet + 65 kg. Pierwsze miejsce w tej kategorii  zdobyła Katarzyna Regent z Koszalińskiego Klubu Karate kyokushin.  Sędzią Głównym zawodów był Andrzej Drewniak 8 dan.\r\n\r\n',
        '2025-07-28', '2025-07-28', 1, 11),
       (57, 'GMINA MIASTA WEJHEROWA 2020',
        'Gmina Miasta Wejherowo wsparła kwotą 3500 zł  realizację zadania \" Szkolenie karate kyokushin\" którą przeznaczymy na najem sali i zakup sprzętu sportowego.',
        '2025-07-28', '2025-07-28', 1, 12),
       (58, 'GMINA MIASTA WEJHEROWA 2021',
        'Gmina Miasta Wejherowa wsparła nasz projekt \" Szkolenie Karate Kyokushin \" kwotą 1500 zł. Umowę podpisano 24.02.2021 roku. Niniejsza dotacja zostanie wykorzystana na najem sali gimnastycznej i zakup sprzętu.',
        '2025-07-28', '2025-07-28', 1, 10),
       (59, 'POWIAT WEJHEROWSKI 2021',
        'Zarząd Powiatu Wejherowskiego wsparł kwotą 1500 zł nasz projekty: \" Szkolenie Karate Kyokushin w Powiecie Wejherowskim kwotą 1500 zł i : Obóz sportowo-wypoczynkowy Lato 2021 \" kwotą 3000 zł',
        '2025-07-28', '2025-07-28', 1, 9),
       (60, 'GMINA MIASTA REDA 2021',
        'Gmina Miasta Reda dofinansowała nasz projekt \" Szkolenie Karate Kyokushin \" kwotą 3000 zł które zamierzamy przeznaczyć na najem sal gimnastycznych i zakup sprzętu\r\n\r\n ',
        '2025-07-28', '2025-07-28', 1, 8),
       (61, 'PROGRAM KLUB 2021', 'Klub uzyskał dotację w wysokości 10.000 zł w ramach Programu Klub 2021', '2025-07-28',
        '2025-07-28', 1, 6),
       (62, 'GMINA MIASTA WEJHEROWA 2022',
        'Gmina Miasta Wejherowa wsparła kwotą 1500 zł nasz projekt \" Szkolenie Karate Kyokushin \" którą przeznaczymy na najem sal gimnastycznych',
        '2025-07-28', '2025-07-28', 1, 7),
       (63, 'PROGRAM KLUB 2022',
        'Otrzymaliśmy dofinansowanie w wysokości 10.000 zł w ramach Programu Klub 2022 na wynagrodzenie Instruktorów i trenerów.',
        '2025-07-28', '2025-07-28', 1, 5),
       (64, 'GMINA MIASTA WEJHEROWA 2023',
        '    Gmina Miasta Wejherowa wsparła nasze zadanie \" Szkolenie karate Kyokushin\" kwotą 1000 zł', '2025-07-28',
        '2025-10-06', 1, 3),
       (65, 'GMINA MIASTA WEJHEROWA 2024!',
        '    Gmina Miasta Wejherowa wsparła nasz projekt \" Szkolenie Karate Kyokushin \" kwotą  1000 ( jeden tysiąc ) złotych. Dotacja będzie przeznaczona na opłatę najmu sal gimnastycznych.  ',
        '2025-07-28', '2026-02-22', 1, 1),
       (66, 'POWIAT WEJHEROWSKI 2024',
        '    Zarząd Powiatu Wejherowskiego wsparł nasz projekt \" Szkolenie Karate Kyokushin \" kwotą 2350 zł , którą zamierzamy przeznaczyć na opłacenie najmu sali, oraz kwotą 3000 zł zadanie \"Obóz sportowo-wypoczynkowy Lato 2024 którą przeznaczymy na opłatę pobytu w OW \" Edyta \" w Muszynie.\r\n\r\n     ',
...
INSERT INTO `subscribers` (`id`, `email`, `is_active`, `token`)
VALUES (1, 'example@gmail.com', 0, NULL);
