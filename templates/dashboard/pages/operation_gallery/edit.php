<?php
	...
	$actionUrl = "/?dashboard=start&subpage=galeria&operation=edit&id=" . ($data['id'] ?? '');
?>
<br>
<h3>Edytuj Zdjęcie</h3>
<br>
<form action="<?= $actionUrl ?>" method="POST" enctype="multipart/form-data" class="timetable-create-form">
