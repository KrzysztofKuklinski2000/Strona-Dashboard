			...
			<tbody>
				<?php foreach($data ?? [] as $row): ?>
					<tr>
						...
						<td class="links">
							<a href="?dashboard=start&subpage=aktualnosci&operation=edit&id=<?php echo $row['id']?>"><i class="fa-regular fa-pen-to-square"></i></a>
							<a href="?dashboard=start&subpage=aktualnosci&operation=delete&id=<?php echo $row['id']?>"><i class="fa-solid fa-trash"></i></a>
							<a href="?dashboard=start&subpage=aktualnosci&operation=show&id=<?php echo $row['id']?>"><i class="fa-solid fa-magnifying-glass"></i></a>
						</td>
						<td>
							<form action="?dashboard=start&subpage=aktualnosci&operation=move"  method="POST">
