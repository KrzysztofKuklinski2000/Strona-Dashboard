        ...
        <table width="600" border="0" cellspacing="0" cellpadding="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding: 40px 30px; color: #333333; line-height: 1.6; font-size: 16px;">
              ...
              <p style="margin-bottom: 0;">Pozdrawiamy,<br><strong>Zespół Klubu</strong></p>
            </td>
          </tr>
          <tr>
            <td style="background-color: #f8f9fa; padding: 20px; text-align: center; font-size: 12px; color: #888888; border-top: 1px solid #eeeeee;">
              <p style="margin: 0;">Otrzymujesz tę wiadomość, ponieważ jesteś zapisany do powiadomień.</p>
            </td>
          </tr>
        </table>
      </td>
