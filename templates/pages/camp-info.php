...
<div style="padding:0px" class="respons-container">
	...
	<div>
		...
		<div class="detail-info">
			<strong>Termin obozu - <?php echo $content->dateStart. ' - '. $content->dateEnd; ?></strong><br>
			<strong>Wyjazd <?php echo $content->dateStart . ' godz '. $content->timeStart . ' ' . $content->cityStart; ?></strong><br>
			<strong>Powrót <?php echo $content->dateEnd . ' godz '. $content->timeEnd . ' ' . $content->cityStart; ?></strong>
		</div>
		<br>
		<br>
		<p>
